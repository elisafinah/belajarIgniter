...
<head>
    ...
    <link href="<?php echo base_url();?>assets/html/css/application.min.css" rel="stylesheet">
...
<nav id="sidebar" class="sidebar" role="navigation">
    ...
    <div class="js-sidebar-content">
        <header class="logo hidden-xs">
            <a href="<?php echo base_url();?>assets/html/index.html">sing</a>
        </header>
        ...
        <ul class="sidebar-nav">
            <li class="active">
                ...
                <ul id="sidebar-dashboard" class="collapse in">
                    ...
                    <li><a href="<?php echo base_url();?>assets/html/widgets.html">Widgets</a></li>
                </ul>
            </li>
            <li>
                <a href="<?php echo base_url();?>assets/html/inbox.html">
                    <span class="icon">
            ...
            <li>
                <a href="<?php echo base_url();?>assets/html/charts.html">
                    <span class="icon">
        ...
        <ul class="sidebar-nav">
            ...
            <li>
                ...
                <ul id="sidebar-extra" class="collapse">
                    ...
                    <li><a href="<?php echo base_url();?>logout" target="_blank" data-no-pjax>Login Page</a></li>
...
<script src="<?php echo base_url();?>assets/html/vendor/jquery/dist/jquery.min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jquery-pjax/jquery.pjax.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/transition.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/collapse.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/dropdown.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/button.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/tooltip.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/alert.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jQuery-slimScroll/jquery.slimscroll.min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/widgster/widgster.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/pace.js/pace.min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jquery-touchswipe/jquery.touchSwipe.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jquery-touchswipe/jquery.touchSwipe.js"></script>

<!-- common app js -->
<script src="<?php echo base_url();?>assets/html/js/settings.js"></script>
<script src="<?php echo base_url();?>assets/html/js/app.js"></script>

<!-- page specific libs -->
<script id="<?php echo base_url();?>assets/html/test" src="vendor/underscore/underscore.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jquery.sparkline/dist/jquery.sparkline.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/d3/d3.min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/rickshaw/rickshaw.min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/raphael/raphael-min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jQuery-Mapael/js/jquery.mapael.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jQuery-Mapael/js/maps/usa_states.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jQuery-Mapael/js/maps/world_countries.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-sass/vendor/assets/javascripts/bootstrap/popover.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/bootstrap-calendar/bootstrap_calendar/js/bootstrap_calendar.min.js"></script>
<script src="<?php echo base_url();?>assets/html/vendor/jquery-animateNumber/jquery.animateNumber.min.js"></script>

<!-- page specific js -->
<script src="<?php echo base_url();?>assets/html/js/index.js"></script>
</body>
</html>